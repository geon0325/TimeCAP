...
- **`gpt_summary`**: GPT-4 generated textual summaries of time series.
- **`gpt_predict_time`**: GPT-4 predictions based on time series.
- **`gpt_predict_text`**: GPT-4 predictions based on textual summaries (**TimeCP**).
- **`gpt_predict_in-context`**: Predictions generated by **TimeCAP**.

## Contextualization of Time Series
...
## Prediction Based on Time Series
